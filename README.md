...
**Kde seženu F# programátory? Nebudou drazí, když musí být matematičtí géniové?** 

Legendy o náročnosti funkcionálního programování přetrvávají, i když jsme už ve 21. století... Znalost matematiky 8. třídy ZŠ je vše, co potřebujete. Na rozdíl od FP dnes tolik nahajpované ML, DL LLM atd. (často nesmyslně označované jako AI) vyžadují znalost matematiky prvních 4 semestrů VŠ technického zaměření (diferenciální počet, operace s maticemi, numerická řešení matematických a pravděpodobnostních modelů - výrazy jako hyperbolická tangenta, extrémy funkce, gradient sestupu, logistická regrese atd. se to tam jen hemží) a nějak to vůbec nikomu nevadí.
